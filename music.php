...
<body>
	<div class="background">
		...
		<br><br>
			...
			<h5 style="font-size:50px; text-align:center;font-family:'DynaPuff', cursive;"><span>MUSIC</span> </h5>
		</div>
	
<div class="container">
<div class="main-video-container">
         <video src="music/sing1.mp4" id="main-video" controls class="main-video">
         </video>
         <h3 class="main-vid-title" id="sargam">sargam</h3>
         <iframe name='frame' style='display:none;'></iframe>
         <form action="music.php" method='post' target='frame' style='display:none'>
            <input type="text" name='videoName' id='videoName' value='sargam'>
      ...
      <div class="video-list-container">
         ...
         <div class="list active">
            <video src="music/sing1.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="sargam">sargam</h3>
         </div>

         <div class="list">
            <video src="music/sing2.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="komal-and-teevra">komal and teevra</h3>
         </div>

         <div class="list">
            <video src="music/sing3.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="teental">teental</h3>
         </div>

         <div class="list">
            <video src="music/sing4.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="ektal">ektal</h3>
         </div>

         <div class="list">
            <video src="music/sing5.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="alankar">alankar</h3>
         </div>
	  
         <div class="list">
         <h4 class="list-title"><button><a href="dance.php">Previous</a></button>  <button><a href="craft.php">   Next  </a></button></h4>
