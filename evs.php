...
<body>
	<div class="background">
		...
		<br><br>
			...
			<h5 style="text-align:center; font-size:30px; font-family:'DynaPuff', cursive"><span>EVS</span>  </h5>
		</div>
	
<div class="container">

<div class="main-video-container">
         <video src="evs/evs1.mp4" id="main-video" controls class="main-video">
         </video>
         <h3 class="main-vid-title" id="evs-part-1">evs part 1</h3>
         <iframe name='frame' style='display:none;'></iframe>
         <form action="evs.php" method='post' target='frame' style='display:none'>
            <input type="text" name='videoName' id='videoName' value='evs part 1'>
      ...
      <div class="video-list-container">
         ...
         <div class="list active">
            <video src="evs/evs1.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="evs-part-1">evs part 1</h3>
         </div>

         <div class="list">
            <video src="evs/evs2.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="evs-part-2">evs part 2</h3>
         </div>

         <div class="list">
            <video src="evs/evs3.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="evs-part-3">evs part 3</h3>
         </div>

         <div class="list">
            <video src="evs/evs4.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="evs-part-4">evs part 4</h3>
         </div>

         <div class="list">
            <video src="evs/evs5.mp4" class="list-video">
            </video>
            <h3 class="list-title" id="evs-part-5">evs part 5</h3>
         </div>

         <div class="list">
         <h4 class="list-title"><button><a href="eng.php">Previous</a></button>  <button><a href="quiz.php">Take quiz</a></button></h4>
